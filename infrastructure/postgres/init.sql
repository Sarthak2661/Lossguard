CREATE TABLE IF NOT EXISTS scored_transactions (
    ...
    order_margin_pct NUMERIC(6, 4) NOT NULL,
    customer_ltv_band TEXT NOT NULL,
    fraud_label BOOLEAN,
    fraud_probability NUMERIC(10, 8) NOT NULL,
    decision TEXT NOT NULL CHECK (decision IN ('approve', 'verify', 'decline')),
    verify_threshold NUMERIC(10, 8) NOT NULL,
    decline_threshold NUMERIC(10, 8) NOT NULL,
    ...
    realized_policy_cost NUMERIC(14, 4),
    baseline_cost NUMERIC(14, 4),
    estimated_savings NUMERIC(14, 4),
...
CREATE TABLE IF NOT EXISTS model_drift_reports (
    ...
    drift_threshold DOUBLE PRECISION NOT NULL,
